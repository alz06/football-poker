...
const STORAGE_KEY = "football_poker_local_v1";
const OLD_STORAGE_KEY = "football_poker_old_v1";

const REGULAR_PLAYERS = [
  { name: "Jahan", color: "p-blue" },
  { name: "Aria", color: "p-green" },
  { name: "Ahmad", color: "p-orange" },
  { name: "Jaffar", color: "p-purple" },
  { name: "Ramin", color: "p-rose" },
  { name: "Farhad", color: "p-cyan" },
  { name: "Reza", color: "p-yellow" },
  { name: "J-Shah", color: "p-lime" },
  { name: "Abbas", color: "p-sky" },
  { name: "Touraj", color: "p-stone" },
];
    ...
    <div className="app-shell">
      <div className="top-card sticky">
        <div className="top-row">
          <div>
            <div className="title">Football-Poker</div>
